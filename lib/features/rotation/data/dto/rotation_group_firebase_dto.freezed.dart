...
// Widget(UI)はDateTimeが適切
 Timestamp get lastScheduledDate; Timestamp get rotationStartDate; Timestamp get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,rotationGroupId,ownerUserId,rotationName,const DeepCollectionEquality().hash(rotationMembers),const DeepCollectionEquality().hash(rotationDays),const DeepCollectionEquality().hash(notificationTime),currentRotationIndex,lastScheduledDate,rotationStartDate,updatedAt);

@override
String toString() {
  return 'RotationGroupFirebaseDto(rotationGroupId: $rotationGroupId, ownerUserId: $ownerUserId, rotationName: $rotationName, rotationMembers: $rotationMembers, rotationDays: $rotationDays, notificationTime: $notificationTime, currentRotationIndex: $currentRotationIndex, lastScheduledDate: $lastScheduledDate, rotationStartDate: $rotationStartDate, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String? rotationGroupId, String ownerUserId, String rotationName, List<String> rotationMembers, List<int> rotationDays, Map<String, int> notificationTime, int currentRotationIndex, Timestamp lastScheduledDate, Timestamp rotationStartDate, Timestamp updatedAt
});
...
as Timestamp,rotationStartDate: null == rotationStartDate ? _self.rotationStartDate : rotationStartDate // ignore: cast_nullable_to_non_nullable
...
class _RotationGroupFirebaseDto extends RotationGroupFirebaseDto {
  const _RotationGroupFirebaseDto({required this.rotationGroupId, required this.ownerUserId, required this.rotationName, required final  List<String> rotationMembers, required final  List<int> rotationDays, required final  Map<String, int> notificationTime, required this.currentRotationIndex, required this.lastScheduledDate, required this.rotationStartDate, required this.updatedAt}): _rotationMembers = rotationMembers,_rotationDays = rotationDays,_notificationTime = notificationTime,super._();
...
@override
int get hashCode => Object.hash(runtimeType,rotationGroupId,ownerUserId,rotationName,const DeepCollectionEquality().hash(_rotationMembers),const DeepCollectionEquality().hash(_rotationDays),const DeepCollectionEquality().hash(_notificationTime),currentRotationIndex,lastScheduledDate,rotationStartDate,updatedAt);
