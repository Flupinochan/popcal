...
part of 'update_rotation_firebase_request.dart';
...
/// @nodoc
mixin _$UpdateRotationFirebaseRequest {
...
/// @nodoc
abstract mixin class $UpdateRotationFirebaseRequestCopyWith<$Res>  {
  factory $UpdateRotationFirebaseRequestCopyWith(UpdateRotationFirebaseRequest value, $Res Function(UpdateRotationFirebaseRequest) _then) = _$UpdateRotationFirebaseRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UpdateRotationFirebaseRequestCopyWithImpl<$Res>
    implements $UpdateRotationFirebaseRequestCopyWith<$Res> {
  _$UpdateRotationFirebaseRequestCopyWithImpl(this._self, this._then);

  final UpdateRotationFirebaseRequest _self;
  final $Res Function(UpdateRotationFirebaseRequest) _then;

/// Create a copy of UpdateRotationFirebaseRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rotationName = null,Object? rotationMemberNames = null,Object? rotationDays = null,Object? notificationTime = null,Object? currentRotationIndex = null,Object? createdAt = null,Object? updatedAt = null,Object? skipEvents = null,Object? userId = null,Object? rotationId = null,}) {
...
/// Adds pattern-matching-related methods to [UpdateRotationFirebaseRequest].
extension UpdateRotationFirebaseRequestPatterns on UpdateRotationFirebaseRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdateRotationFirebaseRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpdateRotationFirebaseRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdateRotationFirebaseRequest value)  $default,){
final _that = this;
switch (_that) {
case _UpdateRotationFirebaseRequest():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdateRotationFirebaseRequest value)?  $default,){
final _that = this;
switch (_that) {
case _UpdateRotationFirebaseRequest() when $default != null:
return $default(_that);case _:
...
class _UpdateRotationFirebaseRequest extends UpdateRotationFirebaseRequest {
  const _UpdateRotationFirebaseRequest({required this.rotationName, required final  List<String> rotationMemberNames, required final  List<Weekday> rotationDays, required this.notificationTime, required this.currentRotationIndex, required this.createdAt, required this.updatedAt, required this.skipEvents, required this.userId, required this.rotationId}): _rotationMemberNames = rotationMemberNames,_rotationDays = rotationDays,super._();
...
@pragma('vm:prefer-inline')
_$UpdateRotationFirebaseRequestCopyWith<_UpdateRotationFirebaseRequest> get copyWith => __$UpdateRotationFirebaseRequestCopyWithImpl<_UpdateRotationFirebaseRequest>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateRotationFirebaseRequest&&(identical(other.rotationName, rotationName) || other.rotationName == rotationName)&&const DeepCollectionEquality().equals(other._rotationMemberNames, _rotationMemberNames)&&const DeepCollectionEquality().equals(other._rotationDays, _rotationDays)&&(identical(other.notificationTime, notificationTime) || other.notificationTime == notificationTime)&&(identical(other.currentRotationIndex, currentRotationIndex) || other.currentRotationIndex == currentRotationIndex)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.skipEvents, skipEvents) || other.skipEvents == skipEvents)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.rotationId, rotationId) || other.rotationId == rotationId));
}
...
/// @nodoc
abstract mixin class _$UpdateRotationFirebaseRequestCopyWith<$Res> implements $UpdateRotationFirebaseRequestCopyWith<$Res> {
  factory _$UpdateRotationFirebaseRequestCopyWith(_UpdateRotationFirebaseRequest value, $Res Function(_UpdateRotationFirebaseRequest) _then) = __$UpdateRotationFirebaseRequestCopyWithImpl;
@override @useResult
$Res call({
 String rotationName, List<String> rotationMemberNames, List<Weekday> rotationDays, TimeOfDay notificationTime, int currentRotationIndex, DateTime createdAt, DateTime updatedAt, SkipEvents skipEvents, String userId, String rotationId
});
...
/// @nodoc
class __$UpdateRotationFirebaseRequestCopyWithImpl<$Res>
    implements _$UpdateRotationFirebaseRequestCopyWith<$Res> {
  __$UpdateRotationFirebaseRequestCopyWithImpl(this._self, this._then);

  final _UpdateRotationFirebaseRequest _self;
  final $Res Function(_UpdateRotationFirebaseRequest) _then;

/// Create a copy of UpdateRotationFirebaseRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rotationName = null,Object? rotationMemberNames = null,Object? rotationDays = null,Object? notificationTime = null,Object? currentRotationIndex = null,Object? createdAt = null,Object? updatedAt = null,Object? skipEvents = null,Object? userId = null,Object? rotationId = null,}) {
  return _then(_UpdateRotationFirebaseRequest(
rotationName: null == rotationName ? _self.rotationName : rotationName // ignore: cast_nullable_to_non_nullable
