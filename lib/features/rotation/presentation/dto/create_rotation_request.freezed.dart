...
mixin _$CreateRotationRequest {
 ...
 UserId get userId; RotationName get rotationName; List<RotationMemberName> get rotationMembers; List<Weekday> get rotationDays; NotificationTime get notificationTime; List<SkipEvent> get skipEvents;
...
@override
int get hashCode => Object.hash(runtimeType,userId,rotationName,const DeepCollectionEquality().hash(rotationMembers),const DeepCollectionEquality().hash(rotationDays),notificationTime,const DeepCollectionEquality().hash(skipEvents));
...
@useResult
$Res call({
 UserId userId, RotationName rotationName, List<RotationMemberName> rotationMembers, List<Weekday> rotationDays, NotificationTime notificationTime, List<SkipEvent> skipEvents
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserId userId,  RotationName rotationName,  List<RotationMemberName> rotationMembers,  List<Weekday> rotationDays,  NotificationTime notificationTime,  List<SkipEvent> skipEvents)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateRotationRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserId userId,  RotationName rotationName,  List<RotationMemberName> rotationMembers,  List<Weekday> rotationDays,  NotificationTime notificationTime,  List<SkipEvent> skipEvents)  $default,) {final _that = this;
switch (_that) {
case _CreateRotationRequest():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserId userId,  RotationName rotationName,  List<RotationMemberName> rotationMembers,  List<Weekday> rotationDays,  NotificationTime notificationTime,  List<SkipEvent> skipEvents)?  $default,) {final _that = this;
switch (_that) {
case _CreateRotationRequest() when $default != null:
return $default(_that.userId,_that.rotationName,_that.rotationMembers,_that.rotationDays,_that.notificationTime,_that.skipEvents);case _:
  return null;
...
class _CreateRotationRequest extends CreateRotationRequest {
  const _CreateRotationRequest({required this.userId, required this.rotationName, required final  List<RotationMemberName> rotationMembers, required final  List<Weekday> rotationDays, required this.notificationTime, required final  List<SkipEvent> skipEvents}): _rotationMembers = rotationMembers,_rotationDays = rotationDays,_skipEvents = skipEvents,super._();
...
@override
int get hashCode => Object.hash(runtimeType,userId,rotationName,const DeepCollectionEquality().hash(_rotationMembers),const DeepCollectionEquality().hash(_rotationDays),notificationTime,const DeepCollectionEquality().hash(_skipEvents));
